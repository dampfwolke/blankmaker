...
class Ui_frm_main_window(object):
    def setupUi(self, frm_main_window):
        ...
        icon = QIcon()
        icon.addFile(u":/Symbole/100-percent.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pb_rechteck.setMinimumSize(QSize(120, 25))
        self.pb_rechteck.setMaximumSize(QSize(135, 30))
        self.pb_rechteck.setFont(font1)
        icon1 = QIcon()
        icon1.addFile(u":/Symbole/cuboid.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_rechteck.setIcon(icon1)
        ...
        self.pb_kreis.setMinimumSize(QSize(125, 25))
        self.pb_kreis.setMaximumSize(QSize(135, 30))
        font2 = QFont()
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Symbole/cylinder.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_kreis.setIcon(icon2)
        ...
        self.gb_spannmittel.setMinimumSize(QSize(400, 120))
        self.gb_spannmittel.setMaximumSize(QSize(800, 250))
        ...
        self.wg_spannmittel_erstellen.setMinimumSize(QSize(0, 30))
        self.wg_spannmittel_erstellen.setMaximumSize(QSize(16777215, 35))
        ...
        self.pb_spannmittel.setMinimumSize(QSize(135, 27))
        self.pb_spannmittel.setMaximumSize(QSize(160, 32))
        self.pb_spannmittel.setFont(font1)
        icon3 = QIcon()
        icon3.addFile(u":/Symbole/vice(1).png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_spannmittel.setIcon(icon3)
        self.pb_spannmittel.setIconSize(QSize(22, 20))
        ...
        self.gb_automatisierung.setMinimumSize(QSize(270, 100))
        self.gb_automatisierung.setMaximumSize(QSize(800, 330))
        ...
        self.pb_wizard_a.setMinimumSize(QSize(90, 25))
        self.pb_wizard_a.setMaximumSize(QSize(100, 30))
        self.pb_wizard_a.setFont(font1)
        icon4 = QIcon()
        icon4.addFile(u":/Symbole/automation.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_wizard_a.setIcon(icon4)
        ...
        self.pb_wizard_b.setMinimumSize(QSize(90, 25))
        self.pb_wizard_b.setMaximumSize(QSize(100, 30))
        self.pb_wizard_b.setFont(font1)
        icon5 = QIcon()
        icon5.addFile(u":/Symbole/circular-arrows.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_wizard_b.setIcon(icon5)
        ...
        sizePolicy4.setHeightForWidth(self.wg_fertigtielmasse.sizePolicy().hasHeightForWidth())
        self.wg_fertigtielmasse.setSizePolicy(sizePolicy4)
        self.wg_fertigtielmasse.setMinimumSize(QSize(300, 100))
        self.wg_fertigtielmasse.setMaximumSize(QSize(550, 120))
        ...
        self.pb_rausspielen.setMinimumSize(QSize(100, 25))
        self.pb_rausspielen.setMaximumSize(QSize(125, 30))
        self.pb_rausspielen.setFont(font1)
        icon6 = QIcon()
        icon6.addFile(u":/Symbole/radioactive.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_rausspielen.setIcon(icon6)
        self.pb_rausspielen.setIconSize(QSize(18, 18))
        ...
        icon7 = QIcon()
        icon7.addFile(u":/Symbole/rpa.png", QSize(), QIcon.Normal, QIcon.Off)
        self.tb_scripts_aufklappen.setIcon(icon7)
#if QT_CONFIG(shortcut)
